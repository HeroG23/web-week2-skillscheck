...
let me = {
    firstName: 'Brian',
    superHeroName: 'The Iron Lumberjack',
    homeTown: 'Clear Lake, IA',
    superPowers: ['Swing of devastation', 'Guard of the iron beard', 'Whistle of hope'],
    superPowerXP(){
        return Math.floor(Math.random() * 100)+1
    } ,
    profileImage(){
        return windows.location.assign("https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg")
    }
}
//////////////////Step 3////////////////////
